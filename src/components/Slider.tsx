...
const slides = [
  {
    ...
    img: "https://images.pexels.com/photos/29367175/pexels-photo-29367175/free-photo-of-stylish-woman-in-pink-shirt-with-fedora-hat.jpeg?auto=compress&cs=tinysrgb&w=600",
    url: "/",
        ...
        {slides.map((slide) => (
          ...
          >
            ...
            <div className='h-1/2 xl:w-1/2 xl:h-full flex flex-col items-center justify-center gap-8 2xl:gap-12 text-center'>
              ...
              <Link href={slide.url}>
                <button className='rounded-md bg-black text-white py-3 px-4'>SHOP NOW
                </button>
              </Link>

            </div>
            {/* Image container */}
            <div className='xl:w-1/2 xl:h-full relative h-1/2'>
